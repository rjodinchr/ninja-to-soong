...
DEST_DIR="${DEST}/vendor/google/graphics/desktop/mesa3d/intel"

bash "${SCRIPT_DIR}/../../../checkout.sh" https://gitlab.freedesktop.org/mesa/mesa 3848a080534a17ca075e9e95dd3a14abb80139aa "${DEST_DIR}"
